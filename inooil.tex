...
It was suggested in 2013 and 2014 that the effects of lithium may be due to
modulation of inositol signalling 
\cite{Toker_Bersudsky_Plaschkes_Inositol_Related_Gene_Knockouts_2014}
\cite{doi:10.1021/cn5001149} suggesting that the signalling
is a better point of intervention if it can be done more
directly. As lithium has recently been considered in Alzheimer's 
due to lower amounts in the diseased state and benefits of supplementation
\cite{PMC12443616}
. However, just with lower stomach acid in old age many metals
may be reduced. Suppplementation may coincidentally modulate a related
pathway as lithium appears to do in the case of inositol but it
does fix the actual problem and therefore is likely to have limited
clinical benefit although it may be quite useful it is also misleading
and ultimately a dead end for a cure. 
Generally nutrient deficincies are expected inositol or a related
...
cause and effect in designing an intervention. 
